...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{11cm}|}
        ...
        \hline
        \textbf{Postcondición}                                                                                          & La alerta queda creada y se envían notificaciones a los usuarios afectados.                                   \\
        \hline
        \multicolumn{2}{|l|}{\textbf{Secuencia Base}}                                                                    \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [1] El usuario accede al panel de gestión de alertas. }                              \\
        \hline
        ...
        \hline
        \multicolumn{2}{|p{15cm}|}{ [5] El usuario introduce título y mensaje de la alerta. }                            \\
        \hline
        ...
        \hline
        \multicolumn{2}{|p{15cm}|}{ [9] El usuario confirma la creación. }                                               \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [10] El sistema crea la alerta y envía notificaciones. }                             \\
        \hline
        \multicolumn{2}{|l|}{\textbf{Secuencia Alternativa}}                                                             \\
        \hline
