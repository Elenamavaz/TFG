...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/DiagramaDeCasoDeUsoCiudadanoi.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/DiagramaDeCasoDeUsoCofrade.drawio.png}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{11cm}|}
        ...
        \hline
        \textbf{Precondición}                                                                                                                      & La procesión está en curso y el usuario tiene conexión a internet.   \\
        \hline
        \textbf{Postcondición}                                                                                                                     & Se muestra la posición actual de la procesión sobre el mapa.         \\
        \hline
        ...
        \hline
        \textbf{Requisitos Relacionados}                                                                                                           & RF-05, RF-07 y RF-16.                                                \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{11cm}|}
        ...
        \hline
        \multicolumn{2}{|p{15cm}|}{ [6] El sistema muestra indicador de ubicación compartida, desde el que el cofrade puede dejar de compartirla en cualquier momento. }                                             \\
        \hline
        \multicolumn{2}{|l|}{\textbf{Secuencia Alternativa}}                                                                                \\
        \hline
        ...
        \hline
        \textbf{Requisitos Relacionados}                                                                                                   & RF-15 y RF-18.                                                                                                 \\
        \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{11cm}|}
        \hline
        \multicolumn{2}{|l|}{\textbf{Caso de uso: Crear notificación}}                                                         \\
        \hline
        \textbf{Resumen}                                                                                                & La Junta de Cofradías crea una notificación para informar a los ciudadanos de su ciudad sobre incidencias o cambios en una procesión o evento. \\
        \hline
        \textbf{Actor}                                                                                                  & Junta de Cofradías                                                                                            \\
        \hline
        \textbf{Precondición}                                                                                           & El usuario tiene rol de Junta de Cofradías.                                                                   \\
        \hline
        \textbf{Postcondición}                                                                                          & La notificación queda creada y visible en la aplicación, y se envía como notificación \emph{push} a los dispositivos registrados en la ciudad.                                   \\
        \hline
        \multicolumn{2}{|l|}{\textbf{Secuencia Base}}                                                                    \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [1] El usuario accede al panel de gestión de procesiones o eventos de su ciudad. }                              \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [2] El usuario selecciona notificar sobre una procesión o evento concreto. }                                      \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [3] El sistema muestra el formulario de creación. }                                  \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [4] El usuario selecciona el tipo de notificación (cancelación, cambio de horario o incidencia). }                                       \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [5] El usuario introduce el mensaje de la notificación. }                            \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [6] El usuario selecciona la prioridad de la notificación. }                               \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [7] El usuario define fecha de expiración (opcional). }                              \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [8] El usuario confirma la creación. }                                               \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [9] El sistema crea la notificación --si el tipo es cancelación, además cambia el estado de la procesión o evento a cancelado-- y la envía como notificación \emph{push} a los dispositivos registrados en la ciudad. }                             \\
        \hline
        \multicolumn{2}{|l|}{\textbf{Secuencia Alternativa}}                                                             \\
        \hline
        ...
        \hline
        \multicolumn{2}{|p{15cm}|}{ [8.a.1] Datos incompletos: El sistema muestra los campos requeridos. }               \\
        \hline
        \multicolumn{2}{|p{15cm}|}{ [9.a.1] Error al enviar el \emph{push}: El sistema registra el error; la notificación queda creada y consultable en la aplicación igualmente. } \\
        \hline
        \textbf{Requisitos Relacionados}                                                                                & RF-27.                                                                                                        \\
        \hline
    \end{tabular}
    \caption{Caso de uso: Crear notificación}
\end{table}
