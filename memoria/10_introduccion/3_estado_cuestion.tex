...
La aplicación presenta una interfaz (Figura \ref{fig:penitente}) en la que el usuario puede consultar información sobre las procesiones y sus recorridos, notificaciones, planificaciones para organizar la Semana Santa y horarios de hermandades o cofradías.
...
\caption{Seguimiento en tiempo real de un vehículo en Uber \cite{uber}}
\label{fig:uber}
\end{figure}
